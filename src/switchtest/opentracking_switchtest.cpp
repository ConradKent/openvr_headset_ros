...
//Menu handler
void menu(int &m_controller_channel, int &m_controller_channel_sel, int m_menupress_right, int m_grippress_right, int m_menupress_last_right, int m_grippress_last_right)
{
//MENU
//00 is controllers0
//01 is controllers/0velocity
//02 is controllers0/waypoint
//03 is controllers0/throwto
//10 is controllers1
//11 is controllers1/velocity
//12 is controllers1/waypoint
//13 is controllers1/throwto
//64 is default
int c_c = m_controller_channel;
int c_c_sel = m_controller_channel_sel;

if (c_c_sel<64 && m_grippress_right == 1 && m_grippress_last_right == 0)
{
	switch(c_c_sel) {
		case 00:
 			c_c_sel=01;
			ROS_WARN("select: controllers0/velocity");
			break;
		case 01:
			c_c_sel=64;
			c_c=01;
			ROS_WARN("controllers0/velocity");
			break;
		case 02:
			c_c_sel=64;
			c_c=02;
			ROS_WARN("controllers0/waypoint");
			break;
		case 03:
			c_c_sel=64;
			c_c=03;
			ROS_WARN("controllers0/throwto");
			break;
		case 10:
			c_c_sel=11;
			ROS_WARN("select: controllers1/velocity");
			break;
		case 11:
			c_c_sel=64;
			c_c=11;
			ROS_WARN("controllers1/velocity");
			break;
		case 12:
			c_c_sel=64;
			c_c=12;
			ROS_WARN("controllers1/waypoint");
			break;
		case 13:
			c_c_sel=64;
			c_c=13;
			ROS_WARN("controllers1/throwto");
			break;}
} else if (m_menupress_right == 1 && m_menupress_last_right == 0)
{
	switch(c_c_sel){
		case 00:
			c_c_sel=10;
			ROS_WARN("select: controllers10");
			break;
		case 01:
			c_c_sel=02;
			ROS_WARN("select: controllers0/waypoint");
			break;
		case 02:
			c_c_sel=03;
			ROS_WARN("select: controllers0/throwto");
			break;
		case 03:
			c_c_sel=01;
			ROS_WARN("select: controllers0/velocity");
		...
		case 10:
			c_c_sel=00;
			ROS_WARN("select: controllers00");
			break;
		case 11:
			c_c_sel=12;
			ROS_WARN("select: controllers1/waypoint");
			break;
		case 12:
			c_c_sel=13;
			ROS_WARN("select: controllers1/throwto");
			break;
		case 13:
			c_c_sel=11;
			ROS_WARN("select: controllers1/velocity");
...
m_controller_channel_sel=c_c_sel;
m_controller_channel=c_c;
}
...
*/
    ...
    ifs1.open(pkglocalpath + "/models/Gazebo_Vive_Wand/left/model.sdf"); //TODO generalize. // "/home/USERNAME/catkin_ws/src/openvr_headset_ros/models/Gazebo_Vive_Wand/left/model.sdf"
    ...
    ifs2.open(pkglocalpath + "/models/Gazebo_Vive_Wand/right/model.sdf"); //TODO generalize. // "/home/USERNAME/catkin_ws/src/openvr_headset_ros/models/Gazebo_Vive_Wand/right/model.sdf"
...
//Menu init
int controller_channel = 64;
int controller_channel_sel = 00;
int menupress_last_right = 0;
int grippress_last_right = 0;
        while(ros::ok())
        {
			...
			menu(controller_channel, controller_channel_sel, menupress_right, grippress_right, menupress_last_right, grippress_last_right);
			menupress_last_right=menupress_right;
			grippress_last_right=grippress_right;
			
			vive.controller_channel = controller_channel;
			vive.controller_channel_sel = controller_channel_sel;
