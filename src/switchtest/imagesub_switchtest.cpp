...
class Menu
{
	public:
		...
		std::string line3;
		std::string line4;
		Menu(std::string init_header, std::string init_line0, std::string init_line1, std::string init_line2, std::string init_line3, std::string init_line4);
		void handler(int m_controller_channel, int m_controller_channel_sel);
};

//Menu Constructor
Menu::Menu(std::string init_header, std::string init_line0, std::string init_line1, std::string init_line2, std::string init_line3, std::string init_line4) {
	header=init_header;
	line0=init_line0;
	line1=init_line1;
	line2=init_line2;
...
void Menu::handler(int m_controller_channel, int m_controller_channel_sel) {
...
//64 is default
	...
	switch(c_c) {
		case 01:
			header="Controls: turtle0, Velocity";
			break;
		case 02:
			header="Controls: turtle0, Waypoint";
			break;
		case 03:
			header="Controls: turtle0, ThrowTo";
			break;
		case 11:
			header="Controls: turtle1, Velocity";
			break;
		case 12:
			header="Controls: turtle1, Waypoint";
			break;
		case 13:
			header="Controls: turtle1, ThrowTo";
			break;
	}
	switch(c_c_sel){
		case 64:
		...
		case 10:
			...
			break;
		case 01:
			line0="->turtle0, Velocity";
			line1="turtle0, Waypoint";
			line2="turtle0, ThrowTo";
			break;
		case 02:
			line0="turtle0, Velocity";
			line1="->turtle0, Waypoint";
		...
		case 03:
			...
			break;
		case 11:
			line0="->turtle1, Velocity";
			line1="turtle1, Waypoint";
			line2="turtle1, ThrowTo";
			break;
		case 12:
			line0="turtle1, Velocity";
			line1="->turtle1, Waypoint";
...
Menu disp_menu( "Press Menu for Controllers", "","","","","");
    ...
    while(ros::ok())
    {
		...
		/*		MESSAGE PURGE (replaced with menu display)
				...
				*/
				...
				display_header=disp_menu.header;
				display_message3=disp_menu.line0;
				display_message2=disp_menu.line1;
