...
int main(int argc, char **argv)
{
  ...
  ros::Subscriber sub_vive = nh.subscribe("openvr_headset_ros/vive", 1, &Vive_Listener::callback, &vive_data);
    ...
    ros::Publisher base_control = nh.advertise<geometry_msgs::Twist>("/turtlesamp/commands/velocity", 1);
    geometry_msgs::Twist base_motion;

    /* get mobile base state*/
    ros::ServiceClient client_get = nh.serviceClient<gazebo_msgs::GetModelState>("/gazebo/get_model_state");
    gazebo_msgs::GetModelState get_state;
    get_state.request.model_name = "turtlebot3_samp_burger";
    ...
    velocity_controller.base_control = nh.advertise<geometry_msgs::Twist>("/turtlesamp/cmd_vel", 1);
    velocity_controller.get_state.request.model_name = "turtlebot3_samp_burger";
    ...
    Way_point_controller.waypoint_name = "waypoint_samp";
    ...
    Way_point_controller.readmodel((pkglocalpath + "/models/controller/samp/model.sdf").c_str()); // readmodel req.s const char* currently // "/home/USERNAME/catkin_ws/src/openvr_headset_ros/models/controller/samp/model.sdf"
    Way_point_controller.client_get = nh.serviceClient<gazebo_msgs::GetModelState>("/gazebo/get_model_state");
    Way_point_controller.base_control = nh.advertise<geometry_msgs::Twist>("/turtlesamp/cmd_vel", 1);
    Way_point_controller.get_state.request.model_name = "turtlebot3_samp_burger";
    ...
    ThrowMethod ThrowTo;
    ThrowTo.trigger = 0;
    ThrowTo.waypoint_name = "waypoint_samp";
    ThrowTo.model_name = "turtlebot3_samp_burger";
    ThrowTo.once = false;
    ...
    ThrowTo.readmodel((pkglocalpath + "/models/controller/samp/model.sdf").c_str()); // readmodel req.s const char* currently // "/home/USERNAME/catkin_ws/src/openvr_headset_ros/models/controller/samp/model.sdf"
