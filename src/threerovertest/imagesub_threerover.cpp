...
//64 is default
	...
	switch(c_c) {
		case 01:
			header="Controller: Survey/Waypoint";
			break;
		case 02:
			header="Controller: Survey/TakeSurvey";
			break;
		case 11:
			header="Controller: Tool/Waypoint";
			break;
		case 12:
			header="Controller: Tool/Velocity";
			break;
		case 21:
			header="Controller: Sample/Waypoint";
			break;
		case 22:
			header="Controller: Sample/Take Survey";
			break;
	}
//--------------------------------------------------------
	switch(c_c_sel){
		...
		case 00:
			line0="->Survey Rover";
			line1="Tool Carrier Rover";
			line2="Sampling Rover";
			break;
		case 10:
			line0="Survey Rover";
			line1="->Tool Carrier Rover";
...
//--------------------------------------------------------			
		case 01:
			line0="->Survey/Waypoint";
			line1="Survey/TakeSurvey";
			line2=" ";
			break;
		case 02:
			line0="Survey/Waypoint";
		...
		case 12:
			...
			break;
		case 21:
			line0="->Sample/Waypoint";
			line1="Sample/TakeSample";
			line2=" ";
			break;
		case 22:
			line0="Sample/Waypoint";
