...
int main(int argc, char **argv)
{
  ...
  ros::Subscriber sub_vive = nr.subscribe("openvr_headset_ros/vive", 1, &Vive_Listener::callback, &vive_data);
    ...
    Way_point_controller.readmodel("/home/zhenyushi/.gazebo/models/controller/right/model.sdf");
    ...
    ThrowTo.readmodel("/home/zhenyushi/.gazebo/models/controller/right/model.sdf");
