...
public:
	...
	std::string model_name; //"turtlebot3_right_burger"
...
public:
	...
	ros::Publisher base_control;//= n.advertise<geometry_msgs::Twist>("/right_turtle/cmd_vel", 1);
...
std::string first_controller = "Right Turtle: Velocity Control";
std::string second_controller = "Right Turtle: Waypoint Control";
std::string third_controller = "Right Turtle: Throw To Control";
...
int main(int argc, char **argv)
{
  ...
  // setup ros node
  ros::init(argc, argv, "vive_controller_right");
  ros::NodeHandle nr;
  ...
  ros::Subscriber sub_vive = nr.subscribe("openvr_headset_ros/vive", 1, &Vive_Listener::callback, &vive_data);



    ros::Publisher gazebo_pub = nr.advertise<gazebo_msgs::ModelState>("gazebo/set_model_state", 10);
    gazebo_msgs::ModelState controller_throw,controller_line;


    /* turtlebot twist command */
    ros::Publisher base_control = nr.advertise<geometry_msgs::Twist>("/right_turtle/cmd_vel", 1);
    geometry_msgs::Twist base_motion;

    /* get mobile base state*/
    ros::ServiceClient client_get = nr.serviceClient<gazebo_msgs::GetModelState>("/gazebo/get_model_state");
    gazebo_msgs::GetModelState get_state;
    get_state.request.model_name = "turtlebot3_right_burger";
    ...
    velocity_controller.client_get = nr.serviceClient<gazebo_msgs::GetModelState>("/gazebo/get_model_state");
    velocity_controller.base_control = nr.advertise<geometry_msgs::Twist>("/right_turtle/cmd_vel", 1);
    velocity_controller.get_state.request.model_name = "turtlebot3_right_burger";
    ...
    Way_point_controller.waypoint_name = "waypoint_right";
    Way_point_controller.once = false;
    Way_point_controller.delete_model = nr.serviceClient<gazebo_msgs::DeleteModel>("/gazebo/delete_model");
    Way_point_controller.spawn_model = nr.serviceClient<gazebo_msgs::SpawnModel>("/gazebo/spawn_sdf_model");
    //Way_point_controller.readmodel((pkglocalpath + "/../../../.gazebo/models/controller/right/model.sdf").c_str()); // readmodel req.s const char* currently // "/home/USERNAME/.gazebo/models/controller/right/model.sdf"
    Way_point_controller.readmodel((pkglocalpath + "/models/controller/right/model.sdf").c_str()); // readmodel req.s const char* currently // "/home/USERNAME/.gazebo/models/controller/right/model.sdf"
    Way_point_controller.client_get = nr.serviceClient<gazebo_msgs::GetModelState>("/gazebo/get_model_state");
    Way_point_controller.base_control = nr.advertise<geometry_msgs::Twist>("/right_turtle/cmd_vel", 1);
    Way_point_controller.get_state.request.model_name = "turtlebot3_right_burger";
    ...
    ThrowMethod ThrowTo;
    ThrowTo.trigger = 0;
    ThrowTo.waypoint_name = "waypoint_right";
    ThrowTo.model_name = "turtlebot3_right_burger";
    ThrowTo.once = false;
    ThrowTo.delete_model = nr.serviceClient<gazebo_msgs::DeleteModel>("/gazebo/delete_model");
    ThrowTo.spawn_model = nr.serviceClient<gazebo_msgs::SpawnModel>("/gazebo/spawn_sdf_model");
    //ThrowTo.readmodel((pkglocalpath + "/../../../.gazebo/models/controller/right/model.sdf").c_str()); // readmodel req.s const char* currently // "/home/USERNAME/.gazebo/models/controller/right/model.sdf"
    ThrowTo.readmodel((pkglocalpath + "/models/controller/right/model.sdf").c_str()); // readmodel req.s const char* currently // "/home/USERNAME/.gazebo/models/controller/right/model.sdf"



     /* for display */
    ros::Publisher ToDisplay = nr.advertise<std_msgs::String>("display_message_ch0", 10);
    std_msgs::String msg;
