...
//Menu handler
void menu(int8 &m_controller_channel, int8 &m_controller_channel_sel, int m_menupress_right, int m_triggerpress_right)
{
//MENU
//00 is controllers0
...
if (c_c_sel<200 && m_triggerpress_right == 1)
{
	switch(c_c_sel) {
		case 00:
 			c_c_sel=01;
...
//Menu init
int8 controller_channel = 200
int8 controller_channel_sel = 00
